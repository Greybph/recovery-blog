...
meta:
  ...
  description: Learn about the fear of missing out that addicts experience when they get sober.
  og:title: FOMO in Early Recovery
  og:description: Learn about the fear of missing out addicts experience when they get sober.
  og:url: https://www.recoveryocean.com/blog/fomo-in-early-recovery
  article:published_time: 6/4/22
  og:image: http://res.cloudinary.com/recovery-ocean/image/upload/v1654555564/fearful_lucktp.jpg
  og:image:secure_url: https://res.cloudinary.com/recovery-ocean/image/upload/v1654555564/fearful_lucktp.jpg
---
...
<div className="bg-slate-100 p-2 rounded-md font-medium"><b className="text-red-500 text-xl">Warning:</b> Fear of missing out on the drug lifestyle can cause relapse and keep an addict trapped in addiction.</div>
