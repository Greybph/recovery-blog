...
id: 7
meta:
  title: Are Drug Addicts Mean? - The Truth May Surprise You
  ...
  og:description: Addicts are people. Some people are jerks and some aren't.
  og:url: https://www.recoveryocean.com/blog/are-drug-addicts-mean
  article:published_time: 6/4/22,
  article:published_time: 6/20/22,
  og:image: https://res.cloudinary.com/recovery-ocean/image/upload/v1654555530/aggression_peqzde.jpg
  og:image:secure_url: https://res.cloudinary.com/recovery-ocean/image/upload/v1654555530/aggression_peqzde.jpg
---
import PostNavigation from '~/components/blog/PostNavigation'
import PostImage from '~/components/utility/PostImage'

# Are Drug Addicts Mean?
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_541/v1654555530/aggression_peqzde.jpg'} by="Image by John Hain" alt="illustration of aggression" posted="Jun 4, 2022"/>
