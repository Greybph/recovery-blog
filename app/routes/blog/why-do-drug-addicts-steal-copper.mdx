...
meta:
  ...
  og:description: Stealing copper... sounds like a lot of work.
  og:url: https://www.recoveryocean.com/blog/why-do-drug-addicts-steal-copper
  article:published_time: 6/4/22
  og:image: http://res.cloudinary.com/recovery-ocean/image/upload/v1654555613/copper-pile_cfl9yz.jpg
...
<strong>Drug addicts steal copper to support their drug habits. Once stolen, an addict can take the copper to a scrap metal yard where they sell it for cash. They will then use the proceeds to purchase drugs.</strong>
