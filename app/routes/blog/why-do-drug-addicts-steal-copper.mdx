...
meta:
  ...
  og:url: https://recoveryocean.com/blog/why-do-drug-addicts-steal-copper
...
import image from '~/assets/posts/9/copper-pile.jpg'
import {Link} from 'remix'

# Why Do Drug Addicts Steal Copper?
<PostImage image={image} alt="sad cartoon man looking down" by="Image by 愚木混株 Cdd20"/>
...
## The Why: Why Drug Addicts Steal Copper?
...
That is why we turn to crime as the primary means of supporting our addictions. There are many illegal ways that an addict can make money to purchase drugs; stealing copper is just one such method.
...
Another potential appeal of stealing copper is that copper is always in demand. While the price of copper fluctuates, there is always a place to sell the stolen material.

<span id="section-3"></span>
## The What: What Do Drug Addicts Do With Stolen Copper? 

Once an addict has stolen the copper, they will try to get rid of it as fast as possible. The longer they have the stolen goods in their possession, the greater the risk of getting caught. 
...
Scrap metal yards tend not to ask questions about where the copper came from. All they'd need to do is transport the stolen goods to a scrap yard, and soon they will have money in hand.

determine its worth. The amount of money that the addict gets for it will depend on the amount and type of copper.
...
## The How: How Do Drug Addicts Steal Copper?
...
Some copper thieves are more creative, posing as construction workers or business owners to gain access to the copper and then stealing it before anybody catches on. Here is a <a href="https://www.bloomberg.com/features/2021-painted-rocks-copper-heist/" target="blank">Bloomber article</a> explaining how thieves used painted rocks to steal $40 million of copper inTurkey.

While these thieves were part of a much bigger operation than your average addict breaking into an abandoned house, it is still an interesting read.
...
I’ve found that most addicts who do steal copper view it as somewhat of a last resort option. They have other preferred methods of making quick cash, and when and if those methods fail, they may turn to stealing copper out of desperation.
