...
meta:
  ...
  og:description: tbd
  og:url: https://recoveryocean.com/blog/do-you-have-to-talk-at-na-meetings
  article:published_time: 6/4/22
  og:image: https://res.cloudinary.com/recovery-ocean/image/upload/v1654555504/na-meeting_lkczdn.jpg
---
import PostNavigation from '~/components/blog/PostNavigation'
import PostImage from '~/components/utility/PostImage'

# Do You Have to Talk at NA Meetings?
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_467/v1654555504/na-meeting_lkczdn.jpg'} by="Photo by Sincerely Media" alt="group at NA meeting with books on their laps" />
