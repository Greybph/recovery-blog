...
meta:
  ...
  og:description: Find out what romance looks like inside of the drug addiction community.
  og:url: https://recoveryocean.com/blog/do-drug-addicts-fall-in-love
  article:published_time: 6/4/22,
  og:image: https://res.cloudinary.com/recovery-ocean/image/upload/v1654555428/heart_akzboj.jpg
---
import PostNavigation from '~/components/blog/PostNavigation'
import PostImage from '~/components/utility/PostImage'

# Do Drug Addicts Fall in Love?
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_467/v1654555428/heart_akzboj.jpg'} by="Photo by Belinda Fewings" alt="Red painted heart symbol" posted="Jun 4, 2022" />
...
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_466/v1655065535/love_katw54.jpg'} by="Image by Brigitte Werner" alt="Couple embracing with starlight in the background" />
...
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_547/v1655065716/dating_rwp3ul.jpg'} by="Image by Piyapong Saydaung" alt="Couple having a dinner date" />
...
<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_495/v1655065790/breakup_lqf0tu.png'} by="Image by Pintera Studio" alt="Couple breaking up going through divorce" />
