...
import image from '~/assets/posts/5/heart.jpg'
import image2 from '~/assets/posts/5/breakup.png'
import image3 from '~/assets/posts/5/dating.jpg'
import image4 from '~/assets/posts/5/love.jpg'

# Do Drug Addicts Fall in Love?

<PostImage image={'https://res.cloudinary.com/recovery-ocean/image/upload/w_701,h_467/v1654555428/heart_akzboj.jpg'} alt="Red painted heart" by="Photo by Belinda Fewings"/>
...
<PostImage image={image4} alt="Sparks fly between a couple" by="Image by Brigitte Werner"/>
...
## The Dating phase
<PostImage image={image3} alt="Couple having a dinner date" by="Image by Piyapong Saydaung"/>
...
## The Breakup
<PostImage image={image2} alt="Couple breaking up going through divorce" by="Image by Pintera Studio"/>
