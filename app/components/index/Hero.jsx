...
function Hero() {
  ...
  return (
    <section className="px-4 pt-24 mb-[2.5rem] md:px-10 lg:px-28 md:pt-32 font-mont">
      ...
      <p className='pt-5 text-xs font-medium leading-7 sm:max-w-lg md:leading-9 md:text-base '>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Velit nisi earum nihil dicta fugit illo. Temporibus, rerum. Iusto asperiores repudiandae excepturi impedit est, tempora dolores?</p>
