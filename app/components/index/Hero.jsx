...
function Hero() {  
 useEffect(() => {
  ...
  return (
    ...
    <button to='/posts' className="relative px-16 py-4 mx-auto mt-10 duration-1000 rounded-md bg-slate-800 group">
      <Link to='/posts' className="text-xl font-medium tracking-tight text-white md:text-2xl">
        Get Started
      </Link>
