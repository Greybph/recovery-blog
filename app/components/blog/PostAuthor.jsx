...
function PostAuthor() {
  ...
  return (
    ...
    <a href="https://www.facebook.com/RecoveryOcean" target="_blank" rel="noreferrer" aria-label='Eric Anderson"s Facebook Page' title="Facebook">
      <div style={{backgroundImage: 'url("' + image + '")'}} className="w-4 h-4 p-10 mb-2 bg-top bg-cover rounded-full md:w-10 md:h-10 md:mr-10 md:p-14 bg-slate-300 md:mb-0">
      </div>
    </a>
        ...
        <div className='flex flex-col items-center justify-center md:block not-prose'>
          ...
          <p className="pt-4 text-base leading-7 tracking-tight text-center md:text-base md:text-left">Eric Anderson is a web developer and <b>recovering</b> drug addict. By sharing his experience in drug addiction and recovery, he hopes to help families who have been impacted by drug addiction.</p>
          <Link to='/about' className='flex items-center float-right pt-10 text-2xl font-bold tracking-tight no-underline text-slate-900 group'>
