...
function ScrollNav() {
  ...
  useEffect(() => {
    ...
    return (
      <div id="scroll-nav" className={`${showScrollNav ?'z-50' : '-z-50'} fixed top-0 left-0 items-center justify-between hidden w-full px-4 py-2 bg-white shadow opacity-0 md:px-12 lg:px-28 lg:flex font-mont`}>
        <Link to='/'>
